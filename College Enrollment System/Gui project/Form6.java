...
public class Form6 extends JFrame implements ActionListener
{
	...
	public Form6()
	{
		...
		l4 = new JLabel("ENTER FACULTY NAME    : ");
		...
		l2 = new JLabel("ENTER FACULTY SALARY : ");
		...
		t1 = new JTextField();
		t1.setBounds(400,230,600,25);
		t1.setFont(new Font("Serif",Font.BOLD,25));
		p2.add(t1);
		
		t2 = new JTextField();
		t2.setBounds(400,330,600,25);
		t2.setFont(new Font("Serif",Font.BOLD,25));
		p2.add(t2);
		
		t3 = new JTextField();
		t3.setBounds(400,430,600,25);
		...
		public void actionPerformed(ActionEvent ae)
		{
			if(ae.getSource()==b1)
			{
			l5.setText("FACULTY DATA ADDED SUCCESSFULLY");
			b3.setText("BACK");
			b2.setText("NEXT");
			}
